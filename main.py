...
# # Load your data
data_aisles = pd.read_csv("aisles.csv/aisles.csv")
data_departments = pd.read_csv("departments.csv/departments.csv")
data_order_products = pd.read_csv("order_products__prior.csv/order_products__prior.csv")
data_orders = pd.read_csv("orders.csv/orders.csv")
data_products = pd.read_csv("products.csv/products.csv")
